...
const translations = {
  en: {
    ...
    aboutTitle: "About",
    aboutParagraph1: "I’m a Tokyo-based Unity Engineer with more than five years of experience building mobile games across both in-game and out-game systems.",
    ...
    workTitle: "Work",
    workIntro: "Personal games built independently, followed by selected professional credits.",
  ...
  "zh-TW": {
    ...
    aboutTitle: "關於我",
    aboutParagraph1: "我是一名在東京工作的 Unity 工程師，五年多來專注於行動遊戲開發，in-game 與 out-game 功能都做。",
    aboutParagraph2: "在 Rudel 我參與三款上線遊戲的開發與營運，後期擔任 Lead Engineer，為新專案建立共用的 UI 與場景管理基礎、程式規範與可重用範本。目前在 Limit Break 負責 Puzzle Panic 的核心玩法開發。",
    aboutParagraph3: "工作之外我也獨立開發遊戲。Planet Drop 已在 Google Play 與 App Store 上架，Pattern Hero 正在開發中，從企劃、程式到送審上架都由我一個人完成。",
    aboutParagraph4: "我以中文、日文、英文與跨國團隊協作。",
    workTitle: "作品",
    workIntro: "由獨立完成的個人遊戲開始，接著是職涯中參與開發的精選作品。",
    personalKicker: "個人作品",
    ...
    locationLabel: "所在地",
    skillsLabel: "核心技能",
    skillsValue: "Unity · C# · 遊戲內／遊戲外開發 · UI 架構 · 非同步系統 · 單元測試 · 除錯工具 · 效能優化",
    languagesLabel: "語言",
  ...
  ja: {
    ...
    aboutTitle: "プロフィール",
    aboutParagraph1: "東京でUnityエンジニアとして勤務し、5年以上にわたりモバイルゲーム開発に携わっています。インゲーム・アウトゲームの両領域を経験しています。",
    ...
    workTitle: "作品",
    workIntro: "個人で開発したゲームと、プロとして携わった作品を分けて紹介します。",
    personalKicker: "個人作品",
